  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-slate-950">Suggested Follow-up Questions</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm text-slate-600">{followUpQuestions.length.toLocaleString()} items</div>
        </div>
      </div>
